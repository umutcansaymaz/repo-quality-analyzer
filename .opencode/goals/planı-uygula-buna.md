...
## NEXT
1. [in_progress] SKIP_SEGMENTS'e artefakt dizinlerini ekle
2. Audit varyantı artifact-report ekle
3. Regression testi: artifact dizinlerinden 0 evidence
4. Döngü testi: bozuk vs düzeltilmiş varyant
5. 449 repo audit + golden + test + build + lint
6. Commit + push + final rapor
